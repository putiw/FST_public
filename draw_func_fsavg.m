function draw_func_fsavg(subject,serverDir,valName,roiName,roiColor,roiWidth,fontSize)
% draw_func_fsavg(subject,serverDir,valName,roiName,roiColor,roiWidth,fontSize)
% Draw functional ROIs in fsaverage space
% subject: subject ID
...
% draw ROI
cvnlookup('fsaverage',6,vals,[min(vals) max(vals)],jet,[],[],1,{'overlayalpha',vals > min(vals),'roiname',roiName,'roicolor',roiColor,'drawroinames',1,'roiwidth',roiWidth,'fontsize',fontSize}); 